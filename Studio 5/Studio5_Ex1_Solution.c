// COMPENG 2DX3 Studio 5 Code for Exercise 1

//  Written by Ama Simons
//  January 30, 2020
//  Last Update: Feb 8, 2024 by Dr. Shahrukh Athar, 
//	This code provides the solution for Studio 5 Exercise 1: 1x2 Keypad (through Push Buttons)
...
int main(void){
	...
	while(1){// Keep checking if a button is pressed 
		...
		// Unique code is: 010 - In order of PM1 PM0 PE0
