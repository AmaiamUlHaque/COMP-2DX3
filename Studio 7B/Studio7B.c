...
// 0.25s = __________ us (Fill in the blank)
void Timer3_Init(void){
	...
	SYSCTL_RCGCTIMER_R = 	0x08;				// (Step 1)Activate timer --> in rgctimer register
	...
	TIMER3_TAPR_R = 0;								// (Step 2-4) Set prescale value to 0; i.e. Timer3 works with Maximum Freq = bus clock freq (120MHz)  
																		// timerFreq = clockFreq / (prescale+1)
