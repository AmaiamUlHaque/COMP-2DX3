...
PortM_Init 
		...
		;STEP 3: Set Port Direction (set bit 0-3 to 0 for INPUT)
		...
		;STEP 4: Enable Digital Functioning (set bit 0-3 to 1 for digital enable)
...
PortN_Init 
		...
		;STEP 3: Set Port Direction (set bit 0-1 to 1 for output)
		...
		;STEP 4: Enable Digital Functioning (set bit 0-1 to 1 for digital enable)
...
Locked_State
		...
		LDR R0, [R1]					
		ORR R0, R0, #0x01				;CLR bit 0 - PN0 controls D2, ON for Locked
		BIC R0, R0, #0x02				;SET bit 1 - PN1 controls D1, OFF for Locked
		STR R0, [R1]					
		BX LR
...
Unlocked_State
		LDR R1, =GPIO_PORTN_DATA_R		
		LDR R0, [R1]					
		BIC R0, R0, #0x01				;CLR bit 0 - PN0 controls D2, OF for Unlocked
