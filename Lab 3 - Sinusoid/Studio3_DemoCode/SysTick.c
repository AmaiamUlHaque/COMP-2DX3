...
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    //SysTick_Wait(1500000);  // wait 12.5ms (assumes 120 MHz clock) 120MHz x 1/80Hz = 12.5ms
		SysTick_Wait(750000);  // wait 12.5ms (assumes 120 MHz clock) 120MHz x 1/160Hz = ???ms
		
		//WANT 80HZ? --> times 2 --> 160Hz
		//120Mhz * 1/160Hz = 120000000/160 = 750000
  }
}
